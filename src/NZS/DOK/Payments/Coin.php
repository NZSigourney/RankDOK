...
class Coin
{
    ...
    public function getPointAPI(): Plugin
    {
        $Point = Server::getInstance()->getPluginManager()->getPlugin("PointAPI");
        return $Point;
    ...
    {
        $a = Server::getInstance()->getPluginManager()->getPlugin("FormAPI");
        $f = $a->createModalForm(function: function (Player $player, $data) {
            if ($data == null) {
                return $this->getForm()->formOpen($player);
            }
            ...
            switch ($data) {
                case 1:
                    ...
                    if ($rank == "Civilian" || $rank == "Soldiers" || "LandLord" || $rank == "Warden" || $rank == "Captain" || $rank == "General" || $rank == "Kings") {
                        $player->sendMessage($this->getMain()->getCfs()->getRs("title.UI") . $this->getMain()->getCfs()->getRs("Civilian.Invalid.Message"));
                    } else {
        ...
        $f = $a->createModalForm(function (Player $player, $data) {
            ...
            switch ($data) {
                case 1:                    
                    ...
                    {
                        $player->sendMessage($this->getMain()->getCfs()->getRs("title.UI") . $this->getMain()->getCfs()->getRs("Soldiers.Invalid.Message"));
                    } else {
                        $this->getPointAPI()->reducePoint($player->getName(), $this->getMain()->getCfs()->getRs("Cost.Coin.Rank.Soldiers"));
                        $player->sendMessage($this->getMain()->getCfs()->getRs("title.UI") . "§b Taken§c " . $this->getMain()->getCfs()->getRs("Cost.Coin.Rank.Soldiers") . "§b From your vault!");
        ...
        $f = $a->createModalForm(function (Player $player, $data) {
            ...
            switch ($data) {
                case 1:
                    ...
                    {
                        $player->sendMessage($this->getMain()->getCfs()->getRs("title.UI") . $this->getMain()->getCfs()->getRs("LandLord.Invalid.Message"));
                    } else {
                        $this->getPointAPI()->reducePoint($player->getName(), $this->getMain()->getCfs()->getRs("Cost.Coin.Rank.LandLords"));
                        $player->sendMessage($this->getMain()->getCfs()->getRs("title.UI") . "§b Taken§c " . $this->getMain()->getCfs()->getRs("Cost.Coin.Rank.LandLords") . "§b From your vault!");
                        //$pp->setGroup($player, "villager");
            ...
            switch($data){
                case 1:
                    ...
                    if ($rank == "Soldiers" || $rank == "Warden" || $rank == "Captain" || $rank == "General" || $rank == "Kings"){
                        $player->sendMessage($this->getMain()->getCfs()->getRs("title.UI") . $this->getMain()->getCfs()->getRs("Warden.Invalid.Message"));
                    }else{
                        $this->getPointAPI()->reducePoint($player->getName(), $this->getMain()->getCfs()->getRs("Cost.Coin.Rank.Warden"));
                        $player->sendMessage($this->getMain()->getCfs()->getRs("title.UI") . "§b Taken§c " . $this->getMain()->getCfs()->getRs("Cost.Coin.Rank.Warden") . "§b From your vault!");
                        //$pp->setGroup($player, "villager");
            ...
            switch($data){
                case 1:
                    ...
                    if ($rank == "Soldiers" || $rank == "LandLord" || $rank == "Captain" || $rank == "General" || $rank == "Kings"){
                        $player->sendMessage($this->getMain()->getCfs()->getRs("title.UI") . $this->getMain()->getCfs()->getRs("Captain.Invalid.Message"));
                    }else{
                        $this->getPointAPI()->reducePoint($player->getName(), $this->getMain()->getCfs()->getRs("Cost.Coin.Rank.Civilian"));
                        $player->sendMessage($this->getMain()->getCfs()->getRs("title.UI") . "§b Taken§c " . $this->getMain()->getCfs()->getRs("Cost.Coin.Rank.Civilian") . "§b From your vault!");
                        $this->onPurePerms()->setGroup($player, "Captain");
                        $this->getMain()->getCfs()->setCfs($player->getName(), "Captain", 1);
                    }
                    break;
                case 2:
                    //$this->getForm()->formOpen($player);
            ...
            switch($data){
                case 1:
                    ...
                    if ($rank == "Soldiers" || $rank == "LandLord" || $rank == "Warden" || $rank == "General" || $rank == "Kings"){
                        $player->sendMessage($this->getMain()->getCfs()->getRs("title.UI") . $this->getMain()->getCfs()->getRs("General.Invalid.Message"));
                    }else{
                        $player->sendMessage($this->getMain()->getCfs()->getRs("title.UI") . "§b Taken§c " . $this->getMain()->getCfs()->getRs("Cost.Coin.Rank.General") . "§b From your vault!");
                        //$pp->setGroup($player, "villager");
